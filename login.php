...
<div class="container-fluid "style="background: linear-gradient(to right,white,lightseagreen)" >
<div class="container">
    <div id="loginbox" style="margin-top:200px;" class="mainbox col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-5">
