<header>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #000000;">
        <div class="container-fluid">
            <a href="index.php"> <img src="images/Mystic.png" id="image"></a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="color: brown; font-size:bold;">
                            <li><a class="dropdown-item " href="search.php?cat=antiques">Antiques</a></li>
                            <li><a class="dropdown-item" href="search.php?cat=pendant">Pendants</a></li>
                            <li><a class="dropdown-item" href="search.php?cat=machine"> Mystical Items</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
